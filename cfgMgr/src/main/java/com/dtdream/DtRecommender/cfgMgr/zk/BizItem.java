...
public class BizItem implements Serializable {
    ...
    public BizItem(String biz_code, String biz_name, String description) {
        this.biz_name = biz_name;
        this.biz_code = biz_code;
        this.description = description;
    }

    public BizItem(String biz_code, String biz_name, String description, String offline_name, String kvStore_name, String dbRec_name, String mqRec_name) {
        this.biz_name = biz_name;
        this.biz_code = biz_code;
        this.description = description;
